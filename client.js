...
${f.suggestion}
  ...
  const markSent = () => {
    ...
    pendingCommentsStore.update((d) => {
      d.sentCommentIds = [.../* @__PURE__ */ new Set([...d.sentCommentIds, ...carriedIds2])];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsdr-dock", onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsdr-dock-head", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsdr-dock-count", title: t("review.dockHint"), children: [
        t("review.dockComments", { n: unsentComments.length }),
        reviewPending ? ` \xB7 ${t("review.dockVerdict")}` : ""
      ] }),
      carryFlash ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsdr-dock-flash", children: carryFlash }) : null,
    ...
    hover ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsdr-dock-list", children: unsentComments.map((comment) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        type: "button",
